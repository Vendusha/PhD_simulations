...
int main(int argc,char**argv) {
  ...
  auto h_interaction_distance_zoom = hc.book1D("Interaction_distance_zoom",128, 0,3, "Interaction_distance_zoom");
  auto h_interaction_distance_x = hc.book1D("Interaction_distance_x",128, 0,3, "Interaction_distance_x");
  auto h_interaction_distance_y = hc.book1D("Interaction_distance_y",128, 0,3, "Interaction_distance_y");
  auto h_interaction_distance_z = hc.book1D("Interaction_distance_z",128, 0,3, "Interaction_distance_z");
