...
int main(int argc,char**argv) {
  ...
  //////////////// Recoils /////////////////////
 auto h_primary_recoil = hc.book1D("Recoil_spectra_PKA", nbins, 0.001, 1000, "Recoil_spectra_PKA");
 h_primary_recoil -> setXLabel("Energy [keV]");
 h_primary_recoil -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Coulomb = hc.book1D("Recoil_spectra_PKA_Coulomb", nbins, 0.001, 1000, "Recoil_spectra_Coulomb");
 h_primary_recoil_Coulomb -> setXLabel("Energy [keV]");
 h_primary_recoil_Coulomb -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Elastic = hc.book1D("Recoil_spectra_PKA_Elastic", nbins, 0.001, 1000, "Recoil_spectra_PKA_Elastic");
 h_primary_recoil_Elastic -> setXLabel("Energy [keV]");
 h_primary_recoil_Elastic -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Inelastic = hc.book1D("Recoil_spectra_PKA_Inelastic", nbins, 0.001, 1000, "Recoil_spectra_PKA_Inelastic");
 h_primary_recoil_Inelastic -> setXLabel("Energy [keV]");
 h_primary_recoil_Inelastic -> setYLabel("Frequency [PKA-1 keV-1]");
 //////////////// Recoils Silicon /////////////////////
 auto h_primary_recoil_Silicon = hc.book1D("Recoil_spectra_PKA_Silicon", nbins, 0.001, 1000, "Recoil_spectra_PKA_Silicon");
 h_primary_recoil_Silicon -> setXLabel("Energy [keV]");
 h_primary_recoil_Silicon -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Silicon_Coulomb = hc.book1D("Recoil_spectra_PKA_Silicon_Coulomb", nbins, 0.001, 1000, "Recoil_spectra_PKA_Silicon_Coulomb");
 h_primary_recoil_Silicon_Coulomb -> setXLabel("Energy [keV]");
 h_primary_recoil_Silicon_Coulomb -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Silicon_Elastic = hc.book1D("Recoil_spectra_PKA_Silicon_Elastic", nbins, 0.001, 1000, "Recoil_spectra_PKA_Silicon_Elastic");
 h_primary_recoil_Silicon_Elastic -> setXLabel("Energy [keV]");
 h_primary_recoil_Silicon_Elastic -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_primary_recoil_Silicon_Inelastic = hc.book1D("Recoil_spectra_PKA_Silicon_Inelastic", nbins, 0.001, 1000, "Recoil_spectra_PKA_Silicon_Inelastic");
 ...
 auto h_primary_recoil_alpha = hc.book1D("Recoil_spectra_PKA_alpha", nbins, 0.001, 1000, "Recoil_spectra_PKA_alpha");
 h_primary_recoil_alpha -> setXLabel("Energy [keV]");
 h_primary_recoil_alpha -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_recoil_PKA_high_Z = hc.book1D("Recoil_spectra_high_Z", nbins,0, 1000, "Recoil_spectra_high_Z");
 h_recoil_PKA_high_Z -> setXLabel("Energy [keV]");
 h_recoil_PKA_high_Z -> setYLabel("Frequency [PKA-1 keV-1]");
 auto h_recoil_PKA_low_Z = hc.book1D("Recoil_spectra_low_Z", nbins, 0,1000, "Recoil_spectra_low_Z");
 h_recoil_PKA_low_Z -> setXLabel("Energy [eV]");
   ...
   // printf("Found event %i/%i [ntrks=%i] ===========================================\n",
     ...
     //////////////////////////////Daughters section////////////////////////////
         ...
         if (primary_recoil->atomicNumber()==14 or primary_recoil->atomicNumber()==13 or primary_recoil->atomicNumber()==12){
           h_recoil_PKA_high_Z ->fill(primary_recoil->startEKin()/Units::eV); }else if(primary_recoil->startEKin()*1000>0.021 && (primary_recoil->atomicNumber()<8 and primary_recoil->atomicNumber()>0)){
           h_recoil_PKA_low_Z ->fill(primary_recoil->startEKin()/Units::eV);}
         if(primary_recoil->atomicNumber()>1){h_primary_recoil->fill(primary_recoil->startEKin()/Units::eV); }
         h_PKA_atomic_number->fill(primary_recoil->atomicNumber());
         if(primary_recoil->atomicNumber()==2){h_primary_recoil_alpha->fill(primary_recoil->startEKin()/Units::eV); }
         // std::cout<<primary_recoil->atomicMass()<<std::endl;
         if(primary_recoil->atomicNumber()==14){h_primary_recoil_Silicon->fill(primary_recoil->startEKin()/Units::eV); }
         ...
         if(primary_recoil -> creatorProcess() == "CoulombScat"){
           ...
           h_primary_recoil_Coulomb->fill( primary_recoil -> startEKin()/Units::eV);
           h_primary_recoil_Silicon_Coulomb->fill( primary_recoil -> startEKin()/Units::eV);
           h_primary_recoil->fill( primary_recoil -> startEKin()/Units::eV);
           ...
           if( primary_recoil->atomicNumber()>1 ){h_primary_recoil_Inelastic->fill(primary_recoil->startEKin()/Units::eV); }
           if( primary_recoil->atomicNumber()>1 ){h_primary_recoil_Silicon_Inelastic->fill(primary_recoil->startEKin()/Units::eV); }
         }else if (primary_recoil->creatorProcess()=="hadElastic"){
           h_PKA_atomic_number_Elastic->fill(primary_recoil->atomicNumber());
           h_primary_recoil_Elastic->fill(primary_recoil->startEKin()/Units::eV);
           h_primary_recoil_Silicon_Elastic->fill(primary_recoil->startEKin()/Units::eV);
         }
 // }
