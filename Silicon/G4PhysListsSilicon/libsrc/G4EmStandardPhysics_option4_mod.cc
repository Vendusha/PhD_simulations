...
//---------------------------------------------------------------------------
//
// ClassName:   G4EmStandardPhysics_option4_mod
//
...
#include "G4PhysListsSilicon/G4ScreenedNuclearRecoil.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmStandardPhysics_option4_mod);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmStandardPhysics_option4_mod::G4EmStandardPhysics_option4_mod(G4int ver, 
							 const G4String&)
  : G4VPhysicsConstructor("G4EmStandard_opt4_mod"), verbose(ver)
{
...
G4EmStandardPhysics_option4_mod::~G4EmStandardPhysics_option4_mod()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardPhysics_option4_mod::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void G4EmStandardPhysics_option4_mod::ConstructProcess()
{
  if(verbose > -1) {
  ...
  G4ScreenedNuclearRecoil* pnuc = new G4ScreenedNuclearRecoil();
  // G4NuclearStopping* inuc = new G4NuclearStopping();
  G4ScreenedNuclearRecoil* inuc = new G4ScreenedNuclearRecoil();
