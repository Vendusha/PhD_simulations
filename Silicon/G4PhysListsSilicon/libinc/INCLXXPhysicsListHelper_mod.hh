...
// ********************************************************************
//
// $Id: INCLXXPhysicsListHelper_mod.hh 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
// ClassName:   INCLXXPhysicsListHelper_mod
//
...
//----------------------------------------------------------------------------
//
#ifndef TINCLXXPhysicsListHelper_mod_h
#define TINCLXXPhysicsListHelper_mod_h 1
...
/**
 * <h1>Physics list helper INCLXXPhysicsListHelper_mod</h1>
 *
 * <h2>Use case</h2>
...
class TINCLXXPhysicsListHelper_mod: public T
{
public:
  TINCLXXPhysicsListHelper_mod(G4int ver = 1);
  virtual ~TINCLXXPhysicsListHelper_mod();
...
#include "INCLXXPhysicsListHelper_mod.icc"
typedef TINCLXXPhysicsListHelper_mod<G4VModularPhysicsList,false,false> QGSP_INCLXX;
typedef TINCLXXPhysicsListHelper_mod<G4VModularPhysicsList,true, false> QGSP_INCLXX_HP;
typedef TINCLXXPhysicsListHelper_mod<G4VModularPhysicsList,false,true> FTFP_INCLXX;
typedef TINCLXXPhysicsListHelper_mod<G4VModularPhysicsList,true, true> FTFP_INCLXX_HP;
